...
Message me privately for full help guide and setup instructions!
    ...
    'es': {
        # ... (keep existing Spanish translations and add new ones)
        'start_private': "Bienvenido al Bot Manager...",  # Add Spanish translations
        'start_group': "Bot Manager está aquí...",        # Add Spanish translations
        'help_private': "Guía de ayuda...",               # Add Spanish translations
        'help_group': "Comandos disponibles..."           # Add Spanish translations
    }
}
